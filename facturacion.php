...
<body>
      ...
      <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
          ...
          <form id="formFactura" name="formFactura">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <label>Fecha</label>
                  <input class="form-control" type="date" id="fecha" name="fecha" value="2011-08-19" id="example-date-input">
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <label>Cliente</label>
                  <select class="custom-select2 form-control" id="cliente" name="cliente" multiple="multiple" style="width: 100%; height: 38px;">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="numFactura" name="numFactura" placeholder="Ejem:0002-0002-0001">
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <label>Rango CAI</label>
                  <input type="text" class="form-control" id="numCai" name="numCai" placeholder="Ejem:0002-0002-0001">
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <select class="custom-select2 form-control" id="producto" name="producto" name="state" style="width: 100%; height: 38px;">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <input id="demo3" class="form-control" type="text" value="" id="cantidad" name="cantidad" name="demo3">
                  </div>
                </div>
              </div>
              <div class="col-md-3">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-success"><i class="icon-copy fa fa-archive"></i>Guardar</button>
  ...
  <script src="vendors/scripts/ValFactura.js"></script>
</body>
