    ...
    <div class="pd-ltr-20">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-8">
            <h4 class="font-20 weight-500 mb-10 text-capitalize">
              <spam class="text-uppercase">Bienvenido de nuevo</spam>
              <div class="weight-600 font-30 text-blue">Ricardo Peralta!</div>
            </h4>
            <p class="font-18 max-width-600">No hagas lo que los demás hacen haz lo que los demás quisieran hacer y no
              se atreven por miedo al exito.</p>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="card-box height-100-p widget-style1">
            <div class="d-flex flex-wrap align-items-center">
              ...
              <div class="widget-data">
                ...
                <div class="weight-600 font-14">Usuaios</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-4 mb-30">
          <div class="card-box height-100-p pd-20">
            <h2 class="h4 mb-20">Objetivo de Ventas</h2>
            <div id="chart6"></div>
          </div>
        </div>
      </div>
